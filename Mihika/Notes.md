...
This document serves as a centralized record of the team's notes, key discussions, decisions, and open questions. It is intended both for internal reference and for sharing relevant updates and discussion points with project mentors.
...
**Main Question:** Can signatures distinguish paths that look different even when basic statistics are similar?
...
**Main Question:** How much additional predictive value do higher signature levels provide relative to their computational cost?
...
**Main Question:** Do signatures capture path information that is not contained in traditional summary statistics?
...
**Main Question:** Do signature-based similarities identify historical windows with more similar path shapes than conventional features?
