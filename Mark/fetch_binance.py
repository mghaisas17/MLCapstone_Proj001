...
Adapted independently for Mark's ML pipeline.
"""
...
# Store data within Mark's directory to maintain independence
RAW_DIR = Path(__file__).resolve().parent / "data" / "raw" / "binance"
...
def fetch_klines(symbol: str, interval: str, start: str, end: str, use_cache: bool = True) -> pd.DataFrame:
    ...
    klines = klines[float_cols]
    
    klines['taker_sell_base'] = klines['volume'] - klines['taker_buy_base']
    klines['imbalance'] = klines['taker_buy_base'] - klines['taker_sell_base']
